<x-app-layout>
    ...
    <div class="dashboard-bg py-12 px-4">
        ...
        <div class="form-container">
            ...
            <h1 class="form-title">✏️ Edit Alumni Information</h1>
            ...
            <form action="{{ route('alumni.update', $alumni->id) }}" method="POST">
                ...
                <div class="form-row">
                    ...
                    <input type="text" name="graduation_year" value="{{ $alumni->graduation_year }}" class="form-input" required>
                </div>

                <!-- Program -->
                <div class="form-row">
                    <label class="form-label">Program</label>
                    <input type="text" name="program" value="{{ $alumni->program }}" class="form-input" required>
                </div>

                <!-- Job -->
                <div class="form-row">
                    <label class="form-label">Job</label>
                    <input type="text" name="job" value="{{ $alumni->job }}" class="form-input">
                </div>

                <!-- Company -->
                <div class="form-row">
                    <label class="form-label">Company</label>
                    <input type="text" name="company" value="{{ $alumni->company }}" class="form-input">
                </div>

                <!-- Phone -->
                <div class="form-row">
                    <label class="form-label">Phone</label>
                    <input type="text" name="phone" value="{{ $alumni->phone }}" class="form-input">
                </div>

                <!-- Address -->
                <div class="form-row textarea-row">
                    <label class="form-label">Address</label>
                    <textarea name="address" class="form-textarea">{{ $alumni->address }}</textarea>
                </div>
