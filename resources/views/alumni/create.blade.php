            ...
            <div class="bg-white shadow sm:rounded-lg p-6">
                <form action="{{ route('alumni.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="graduation_year" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                    </div>

                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700">Program</label>
                        <input type="text" name="program" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                    </div>

                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700">Job</label>
                        <input type="text" name="job" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                    </div>
